					...
					<div class="span9">
						...
						<div class="row-fluid">
							...
							<div class="span7">
				                ...
				                <?php /*
                            	<a data-id="<?php echo $value->terlaris ?>" href="<?php echo CHtml::normalizeUrl(array('setStatus', 'id'=>$value->id, 'type'=>'terlaris')); ?>" class="btn btn-small btn-terlaris">Terpopular <i class="fa fa-square-o"></i></a>
	...
	<script type="text/javascript">
		jQuery(function ( $ ) {
			...
			$('.btn-terlaris').setStatusAjax({
				content: 'Terpopular <i class="fa fa-square-o">',
				contentOK: 'Terpopular <i class="fa fa-check-square-o">',
				class: 'btn-ok',
				classOK: 'btn-primary',
			})
