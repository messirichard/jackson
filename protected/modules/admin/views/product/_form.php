...
// exit;
				...
				*/ ?>
                ...
                <span class="formwrapper">
					...
					<?php /*
                	<?php echo $form->checkBox($model, 'terlaris') ?> Terpopular &nbsp;
				...
				<div class="row-fluid">
					...
					<div class="span4">
						<?php echo $form->textFieldRow($model,'harga_retail',array('class'=>'input-block-level')); ?>
					</div>
					<div class="span3">
	...
	<div class="span4">
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
				...
				'hint'=>'<b>Note:</b> Image size is 726 x 507px. Larger image will be automatically cropped.', 'style'=>"width: 100%")); ?>
				<?php if ($model->scenario == 'update'): ?>
				<img style="width: 100%;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(726,507, '/images/product/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				<?php endif; ?>
		    </div>
		</div>
		<!-- ----------------- Gambar Tambahan ----------------- -->
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
		    	...
		    	<p class="help-block"><b>Note:</b> Image size is 726 x 507px. Larger image will be automatically cropped.</p>
				<style>
