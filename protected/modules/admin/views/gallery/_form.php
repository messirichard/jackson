	...
	<div class="widget">
		...
		<div class="widgetcontent">
			...
			foreach ($modelDesc as $key => $value) {
			    ...
			    echo $form->textArea($value,'['.$lang->code.']sub_title',array('class'=>'span10', 'maxlength'=>200));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
				...
				<?php
				echo $form->labelEx($value, '['.$lang->code.']sub_title_2');
			    echo $form->textField($value,'['.$lang->code.']sub_title_2',array('class'=>'span10', 'maxlength'=>200));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
	...
	<div class="span4">
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
				...
				'hint'=>'<b>Note:</b> Ukuran gambar adalah 570 x 118px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
				<?php if ($model->scenario == 'update'): ?>
				<img style="max-width: 100%;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(570,118, '/images/gallery/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				<?php endif; ?>
		    </div>
		</div>
		<?php /*
