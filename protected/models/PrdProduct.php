...
class PrdProduct extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tag, data[size], data[packing], data[return], data[shipping], data[color], data[feature], data[qty_pack], data[garansi_teks], data[garansi_nilai], filter, harga_coret', 'safe'),
