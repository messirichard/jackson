	...
	'clientOptions'=>array(
		'validateOnSubmit'=>false,
					...
					<div class="box-account-history">
						<h1 class="title">Sudah punya account? login!</h1>
						<div class="clear height-30"></div>
						
						<div class="basic-information form-horizontal">
						<?php echo CHtml::errorSummary($modelLogin, '', '', array('class'=>'alert alert-danger')); ?>
						<div class="form-group">
							<label class="control-label col-sm-4 required" for="LoginForm2_username">Account Number / Email <span class="required">*</span></label>
						    <div class="col-sm-6">
	...
	'clientOptions'=>array(
		'validateOnSubmit'=>false,
					...
					<div class="box-account-history">
						...
						<?php echo CHtml::errorSummary($modelLogin, '', '', array('class'=>'alert alert-danger')); ?>
						<div class="form-group">
							<label class="control-label col-sm-4 required" for="LoginForm2_username">Account Number <span class="required">*</span></label>
						    <div class="col-sm-6">
						    	<?php echo $form->textField($modelLogin, 'username', array('class'=>'form-control')) ?>
						    </div>
						</div>
