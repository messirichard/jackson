<div class="blocks_subpage_banner promotion mih393 inside_top_illustration" style="background: none; background-image: none;">
    <div class="picts_full">
      <img src="<?php echo Yii::app()->baseUrl.'/images/static/'.$this->setting['contact_hero_image']; ?>" alt="<?php echo $this->setting['contact_hero_title'] ?>" class="img-responsive center-block">  
    </div>
    
    <?php if ($this->setting['contact_hero_title']): ?>
    <div class="outers_block_text">
      <div class="prelatife blocks_text">
        <h3 class="sub_title_p"><?php echo $this->setting['contact_hero_title'] ?></h3>
      </div>
    </div>
    <?php endif; ?>
</div>
