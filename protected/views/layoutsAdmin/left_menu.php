<div class="leftmenu">        
    <ul class="nav nav-tabs nav-stacked">
        ...
        <li class="dropdown"><a href="<?php echo CHtml::normalizeUrl(array('/admin/product/index')); ?>"><span class="fa fa-tag"></span> <?php echo Tt::t('admin', 'Products') ?></a>
            <ul>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/product')); ?>">Product Discount</a></li>
        ...
        <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/promo/index')); ?>"><span class="fa fa-fax"></span> <?php echo Tt::t('admin', 'Voucher') ?></a></li>
        ...
        */ ?>
        <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/home')); ?>"><span class="fa fa-building"></span> <?php echo Tt::t('admin', 'Homepage') ?></a></li>
        <li class="dropdown"><a href="<?php echo CHtml::normalizeUrl(array('/admin/slide/index')); ?>"><span class="fa fa-heart"></span> <?php echo Tt::t('admin', 'Promotion/Slide') ?></a>
            <ul>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/popup')); ?>">Promo Pop Up</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/promotion')); ?>">Promotion Hero Image</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/slide/index')); ?>">View Promotion/Slide</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/slide/create')); ?>">Create Promotion/Slide</a></li>
            </ul>
        </li>
        <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/about')); ?>"><span class="fa fa-building"></span> <?php echo Tt::t('admin', 'About') ?></a></li>
        ...
        <li class="dropdown"><a href="#"><span class="fa fa-heart"></span> <?php echo Tt::t('admin', 'Faq') ?></a>
            <ul>
            <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/faq')); ?>"><span class="fa fa-tag"></span> <?php echo Tt::t('admin', 'Faq Content') ?></a></li>
            <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/faq/index')); ?>"><span class="fa fa-rss"></span> <?php echo Tt::t('admin', 'FAQ') ?></a></li>                
            </ul>
        </li>
